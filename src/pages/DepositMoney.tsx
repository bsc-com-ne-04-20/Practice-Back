...
const DepositMoney: React.FC<DepositMoneyProps> = ({ username, onLogout, setBalance, setTransactions }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/api/v1/dpst/', {
        email: recipient,
        amount: amountNum,
      });
